  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative z-10 px-8 md:px-24 py-24 flex flex-col justify-center h-full textal">
          ...
          <div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  Our selection of fresh oysters, limes. CTE
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="w-full bg-black text-white">
        ...
        <div className="relative py-6 px-4 flex flex-col items-center">
          ...
          <div className="flex justify-between w-full absolute top-1/2 px-4">
            <button
